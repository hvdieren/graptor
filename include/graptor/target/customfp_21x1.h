// -*- c++ -*-
#ifndef GRAPTOR_TARGET_CUSTOMFP_21x1_H
#define GRAPTOR_TARGET_CUSTOMFP_21x1_H
...
public:
    ...
    using itype = vpair<__m256i,__m256i>;
    using vmask_type = vpair<__m256i,__m256i>;
    using mask_type = __mmask16;

    // using enc_traits = avx2_8x4<uint64_t>;
    using cfp3_traits = customfp_21x3<E,M>;
    // using int_traits = vector_type_traits<uint32_t,sizeof(float)*12>;
    // using fp_traits = vector_type_traits<float,sizeof(float)*12>;
	...
	return cfp3_traits::lane( a, idx%3 );
    }
    ...
    static vpair<__m256,__m256i> cvt_to_float( type a ) {
	...
	return vpair<__m256,__m256i>{
	    _mm256_castsi256_ps( c01 ), _mm256_castsi256_ps( c2 ) };
    }
    static type cvt_to_cfp( vpair<__m256,__m256i> as ) {
	static_assert( E == 6 && M == 15, "defines dmask" );
...
#endif // GRAPTOR_TARGET_CUSTOMFP_21x1_H
