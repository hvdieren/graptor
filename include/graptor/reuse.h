...
// Ref: http://www.cs.cmu.edu/afs/cs/academic/class/15745-s07/www/papers/ding-pldi03.pdf
...
public:
    ...
    std::pair<size_t,size_t> access(IntTy idx) {
	if( nsteps == 0 )
